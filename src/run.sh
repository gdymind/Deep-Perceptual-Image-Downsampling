...
python main.py --loss 1*SSIM --data_name DIV2K/HighRes --data_range 1-100/1-12 --epochs 200 --lr_decay 20 --lr 0.001 --reset y --scales 4 --patch_size 512 --n_ResDenseBlock 16 --n_dense_layer 8 --model DPIDU
